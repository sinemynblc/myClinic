...
class SubmitLeaveRequestView(APIView):
    ...
    def post(self, request):
        ...
        if conflicts:
            response_data['warning'] = f"Conflicting appointments: {list(conflicts)}"
...
class AnalyticsView(APIView):
    ...
    def get(self, request):
        ...
        doctor_performance = Doctor.objects.annotate(
            appointment_count=Count('appointments', filter=__import__('django.db.models', fromlist=['Q']).Q(
                appointments__date_time__date__gte=start_date,
                appointments__date_time__date__lte=end_date
            )),
            avg_rating=Avg('appointments__patient_rating', filter=__import__('django.db.models', fromlist=['Q']).Q(
                appointments__date_time__date__gte=start_date,
                appointments__date_time__date__lte=end_date
            ))
